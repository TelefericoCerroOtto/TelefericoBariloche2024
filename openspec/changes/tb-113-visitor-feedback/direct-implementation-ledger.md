...
- **Identity and scope:** On `feat/app-cms-root-tb-113-checkpoint-stage-validation`, based at exact open parent #349 head `d7e41988cbb9a42865776d4adb4e7d0e7eff1e12`, added strict local validation for the worker's direct-route render/store checkpoint subset. This exact candidate has a user-approved, candidate-only `size:exception` capped at 4,000 additions plus deletions; no later candidate inherits it.
...
- **Authored size:** `471` additions plus deletions across all seven changed paths against exact parent head `d7e41988cbb9a42865776d4adb4e7d0e7eff1e12`, including this ledger entry. This is within the approved candidate-only 4,000-line exception; default for later candidates remains 800.
